...
const messages = new Map(); // key is room id and value is message object
const clients = new Map(); // key is socket and vsalue is senderId
const clientNames = new Map(); // key is socket and value is name
const sockettoroomId = new Map(); // key is socket and value is roomId
let clientCounter = 0;
